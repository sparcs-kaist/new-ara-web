<template>
    <TheLayout>
      <div class="the-makers makers-1 mb" >
        ...
        <p class="header header-desc">Description</p>
        <div class="desc">
          <p>
    ...
    return {
      ...
      projects: [
        ...
        {name: 'NeoAra & WebAra',
          ...
          members: ['airlover:김유승', 'pcpenpal:박용수', 'softdie:김동주']},
        {name: 'Arara 1세대',
          period: '2008~',
          remark: '',
        ...
        {name: '아라플러스',
          period: '2015~2016',
          remark: 'WIP',
          desc: "아라플러스는 사용자들이 특정 주제에 대해 채팅을 나눌 수 있는 '불판', 동아리나 자치단체, 소모임을 위한 '그룹게시판', 익명 글작성, 포인트 제도 등 커뮤니티 활동을 즐길 수 있는 풍부한 기능들을 새로운 UI와 함께 제공하여 KAIST 학생 사회에서 ARA를 다시 활성화시키고자 했던 프로젝트입니다.",
